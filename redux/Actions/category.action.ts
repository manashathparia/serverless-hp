...
export const getCategoryPostsAction = (_posts) => {
...
export const updateViewingCategory = (categoryName) => ({
    type: UPDATE_CURRENT_CATEGORY,
    payload: categoryName,
});

export const updateTotalCategoryPageAction = (postsNo, pagesNo) => ({
...
export const getWpCategoryPosts = (slug) => async (dispatch) => {
    try {
